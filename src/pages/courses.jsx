  ...
  return (
    <>  
      ...
      <title>courses - DSK Makeover & Academy</title>
        ...
        />
        <meta name="keywords" content="makeup courses, beauty training, DSK Academy, bridal makeup course" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "description": "A comprehensive makeup course designed to take you from beginner to pro.",
              "provider": {
                "@type": "Organization",
