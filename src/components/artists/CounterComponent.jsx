const CounterSection = () => {
  return (
<section className= "min-h-[600px] w-full bg-black py-8 flex flex-col items-center justify-center gap-20 font-montserra  md:flex-col lg:flex-row md:items-center md:justify-center md:gap-28 ">      
  <div>
